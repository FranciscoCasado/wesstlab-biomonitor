...
static const uint16_t pAuxRamImage[] = {
    ...
    /*0x00C0*/ 0x6436, 0xBDB7, 0x241A, 0xA6FE, 0xADB7, 0x641A, 0xADB7, 0x0000, 0x007E, 0x0081, 0x00BE, 0x0000, 0x0000, 0xFFFF, 0x0000, 0x0000, 
    /*0x00E0*/ 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0005, 0x0003, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0001, 0x0C67, 
    /*0x0100*/ 0xADB7, 0x705D, 0x6003, 0x14BF, 0x7041, 0x1462, 0xFB4D, 0x8609, 0x7101, 0x6431, 0x2531, 0xA6FE, 0xFB00, 0x7078, 0xFB54, 0x7018, 
    /*0x0120*/ 0xFB4C, 0x7003, 0xFB4C, 0xFD47, 0xFB4C, 0x1465, 0x70BC, 0x6007, 0x14BF, 0x0000, 0x1075, 0xFF19, 0x14C5, 0x6403, 0x001F, 0x8B2C, 
    /*0x0140*/ 0xFDB1, 0x8902, 0x0C7B, 0x0001, 0x1075, 0xFF19, 0x14C5, 0x6403, 0x001F, 0x8B2C, 0xFDB1, 0x8902, 0x0C7A, 0x0002, 0x1075, 0xFF19, 
    /*0x0160*/ 0x14C5, 0x6403, 0x001F, 0x8B2C, 0xFDB1, 0x8902, 0x0C79, 0x14D2, 0x086C, 0x8201, 0x0C6C, 0x0001, 0x0C67, 0xADB7, 0xADB7, 0xFB0C, 
    /*0x0180*/ 0xEDA4, 0xEB09, 0x640B, 0xCDB1, 0xADB7, 0xF007, 0x1462, 0x86FF, 0x63F8, 0xEB51, 0x8680, 0x6000, 0xED8F, 0xEB49, 0xFD47, 0xEB49, 
    /*0x01A0*/ 0x1465, 0xADB7, 0x1462, 0x7079, 0xFB55, 0x71FB, 0xFB54, 0xFD47, 0xFB54, 0x1465, 0x4431, 0x4400, 0xADB7
};
...
//  cfg         input       output      state       
    0x004010EA, 0x00000000, 0x003010F2, 0x002010F8  // ADCEDA
};
...
void scifReinitTaskIo(uint32_t bvTaskIds) {
    if (bvTaskIds & (1 << SCIF_ADCEDA_TASK_ID)) {
        scifReinitIo(5, -1);
        scifReinitIo(3, -1);
        scifReinitIo(0, -1);
    }
